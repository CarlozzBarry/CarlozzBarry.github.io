...
function coordinatesHb(event){
	var hbxpos = 1-(450-event.touches[0].clientX)/450;
	var hbypos = (450-event.touches[0].clientY)/450;
	...
	function coordinatesFh(event){
		var fhxpos = 1-(900-event.touches[0].clientX)/450;
		var fhypos = (450-event.touches[0].clientY)/450;
	...
	function coordinatesWc(event){
		var wcxpos = 1-(1350-event.touches[0].clientX)/450;
		var wcypos = (450-event.touches[0].clientY)/450;
